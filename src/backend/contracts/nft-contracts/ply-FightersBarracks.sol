 ...
 */
contract FightersBarracksPly is CcipNftBridge {
    ...
    {
        require(_router == PLY_MUMBAI_CCIP_ROUTER, "Not allowed router.");
    }
    ...
    function _updateNftStateOnSendChainSpecifics(uint256 _nftId) internal override {
        ...
        emit ICCIPNftBridge__NftSent(msg.sender, PLY_MUMBAI_CHAIN_ID, _nftId, block.timestamp);
    }
        ...
        override
    {
        ...
        emit ICCIPNftBridge__NftReceived(_owner, PLY_MUMBAI_CHAIN_ID, _nftId, block.timestamp);
    }
